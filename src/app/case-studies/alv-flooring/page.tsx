            ...
            <div className="space-y-6 text-gray-600 text-base leading-relaxed">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 not-prose">
                <div className="bg-gray-50 rounded-xl border border-gray-100 p-5 text-center">
                  ...
                  <p className="text-gray-500 text-sm mt-1">Days to #1</p>
                </div>
                <div className="bg-gray-50 rounded-xl border border-gray-100 p-5 text-center">
                ...
                <div className="bg-gray-50 rounded-xl border border-gray-100 p-5 text-center">
                  <p className="text-2xl font-bold text-blue-600">333%</p>
                  <p className="text-gray-500 text-sm mt-1">More Sales Calls</p>
                </div>
                <div className="bg-gray-50 rounded-xl border border-gray-100 p-5 text-center">
                  <p className="text-2xl font-bold text-blue-600">47</p>
                  <p className="text-gray-500 text-sm mt-1">GBP Calls</p>
                </div>
              </div>
                ...
                <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    <tr className="bg-white">
                      <td className="px-5 py-3 text-gray-900 font-medium">&ldquo;Flooring Contractors&rdquo;</td>
                      <td className="px-5 py-3 text-blue-600 font-bold">#1 Organic + #1 Map Pack</td>
                      <td className="px-5 py-3 text-gray-500">Day 18</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="px-5 py-3 text-gray-900 font-medium">&ldquo;Affordable Flooring&rdquo;</td>
                      <td className="px-5 py-3 text-blue-600 font-bold">#1 Organic</td>
                      <td className="px-5 py-3 text-gray-500">Day 19</td>
                    </tr>
                    <tr className="bg-white">
                      <td className="px-5 py-3 text-gray-900 font-medium">&ldquo;Laminate Flooring&rdquo;</td>
                      <td className="px-5 py-3 text-blue-600 font-bold">#2, directly behind Home Depot</td>
                      <td className="px-5 py-3 text-gray-500">Day 21</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="px-5 py-3 text-gray-900 font-medium">&ldquo;LV Flooring Smyrna TN&rdquo;</td>
                      <td className="px-5 py-3 text-blue-600 font-bold">#2 Organic + #1 Map Pack</td>
                      <td className="px-5 py-3 text-gray-500">Day 24</td>
                    </tr>
                    <tr className="bg-white">
                      <td className="px-5 py-3 text-gray-900 font-medium">&ldquo;Waterproof Flooring&rdquo;</td>
                      <td className="px-5 py-3 text-blue-600 font-bold">#2, above Home Depot</td>
                      <td className="px-5 py-3 text-gray-500">Day 26</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-4 not-prose">
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-100 p-6 text-center">
                  ...
                  <p className="text-gray-600 text-sm mt-1 font-medium">New Keywords Ranked</p>
                  <p className="text-gray-400 text-xs mt-1">15 to 84 total</p>
                </div>
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-100 p-6 text-center">
                  <p className="text-3xl font-bold text-blue-600">333%</p>
                  <p className="text-gray-600 text-sm mt-1 font-medium">Increase in Sales Calls</p>
                  <p className="text-gray-400 text-xs mt-1">Direct revenue impact</p>
                </div>
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-100 p-6 text-center">
                  <p className="text-3xl font-bold text-blue-600">47</p>
                  <p className="text-gray-600 text-sm mt-1 font-medium">Google Business Calls</p>
