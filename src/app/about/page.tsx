...
const differentiatorFeatures = [
  {
    ...
    title: 'Department-Specific Specialists',
    description: 'Dedicated SEO, ORM, and white label teams — not generalists juggling unrelated projects. Every specialist focuses on what they do best.',
  },
  {
  ...
  },
  {
    ...
    description: "Our work is driven by outcomes. We measure success by tangible improvements in your search rankings, not by the volume of tasks completed.",
  },
  {
