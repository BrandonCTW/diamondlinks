...
export const metadata: Metadata = {
  ...
  description: 'Personal online reputation management for professionals and executives. DiamondLinks suppresses negative search results and builds a positive digital footprint — results in 90–120 days.',
