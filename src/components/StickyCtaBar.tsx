        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 flex items-center gap-4">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 bg-blue-600 text-white px-5 py-2 rounded-lg text-sm font-bold hover:bg-blue-500 transition-colors shadow-lg shadow-blue-600/30 whitespace-nowrap"
            >
              Get Free Analysis
              <svg
